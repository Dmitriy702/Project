...
public class Address {
    ...
    private static String house() {
        ...
        try {
            return InputData.input("^[1-9][0-9]{0,3}([a-zA-Z]|[а-яА-Я]|(\\/[1-9][0-9]{0,1}))?$",
                    Messages.HOUSE_EXCEPTION);
        }
        catch (InputException exception){
    ...
    private static String apartment() {
        ...
        try {
            return InputData.input("^[1-9][0-9]{0,3}([a-zA-Z]|[а-яА-Я])?$",
                    Messages.APARTMENT_EXCEPTION);
        }
        catch (InputException exception){
